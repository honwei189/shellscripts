...
###
 ...
 # @last modified     : 14/04/2020 14:14:23
...
#e.g:
#    location / {
#        include /etc/nginx/conf.d/server/check_white_ip.conf;
#    }
...
################################################################
whitelist="/etc/nginx/conf.d/whitelist.conf"
